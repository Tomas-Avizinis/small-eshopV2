...
let myMoney = 200;
let myWeight = 30;
const fullScreen = document.querySelector('.main-container');
const products = document.querySelector('#shop-products');
const inventory = document.querySelector('#my-products');
...
const addItemBtn = document.querySelector('#add-to-shop');
addItemBtn.onclick = () => {
    ...
    items.forEach(item => {
        ...
        addItemBtn.onclick = () => {
            ...
            if (checkMoney >= 0 && checkWeight >= 0) {
                ...
                displayResources();
                const purchasedItem = card.cloneNode(true);
                const purchasedItemInfo = purchasedItem.lastChild;
                const removeItemBtn = purchasedItemInfo.lastChild;
